...
typedef std::vector<int> digit_list; //int is really too big (for 0-9)
...
public: 
	...
	Integer();
	// overload constructor, set to given string value (of all digist)
...
private:
	...
	bool negative;  // true if the calue is less than zero
